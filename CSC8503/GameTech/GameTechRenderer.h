...
namespace NCL {
	class Maths::NCLVector3;
	class Maths::NCLVector4;
	namespace CSC8503 {
		class RenderObject;
		class D_GUI;
		...
		protected:
			...
			NCLMatrix4 SetupDebugLineMatrix()	const override;
			NCLMatrix4 SetupDebugStringMatrix()const override;
