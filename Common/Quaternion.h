...
namespace NCL {
	namespace Maths {
		...
		public:
			...
			Quaternion(const NCLVector3& vector, float w);

			Quaternion(const NCLMatrix3 &m);
			Quaternion(const NCLMatrix4 &m);
			...
			static Quaternion FromToRotation(NCLVector3 aFrom, NCLVector3 aTo);
			...
			NCLVector3		operator *(const NCLVector3 &a)	const;
